...
public class GenericFilterCriteriaBuilder {
    ...
    static {
        ...
        //mongodb contains string case-insensitive
        FILTER_CRITERIA.put("CONTAINS_CASE_INSENSITIVE", condition -> Criteria.where(condition.getField()).regex(buildLikeString((String) condition.getValue()), "i"));
